...
{
    /// <summary>
    /// The exception that is thrown when adding duplicate regulation rule.
    /// </summary>
    [Serializable]
    public class RegulationRuleAlreadyExistsException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegulationRuleNotFoundException"/> class.
        /// </summary>
        public RegulationRuleAlreadyExistsException()
        {
        }
        ...
        protected RegulationRuleAlreadyExistsException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        public RegulationRuleAlreadyExistsException(string message)
            : base(message)
        {
        }
        ...
        public RegulationRuleAlreadyExistsException(string message, Exception innerException)
